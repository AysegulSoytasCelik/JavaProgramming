...
public class GreatCalculator {
    public static void main(String[] args) {
        ...
        gradeOfA.removeIf(p-> !(p>= 90&& p<=100)); //gradeA olanlar disindakiler ayiklaniyor
        ...
        System.out.println("Total number of A: "+gradeOfA.size()); //how many person in the grade A==size
