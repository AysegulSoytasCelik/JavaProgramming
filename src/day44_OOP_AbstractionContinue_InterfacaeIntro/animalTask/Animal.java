...
public abstract class Animal {
    ...
    //eat method with abstract
    public abstract void eat(); //should add the "abstract" in the class name too
...
//if you add this part as a"getClass().getSimpleName()+", you can call subclasses own name
