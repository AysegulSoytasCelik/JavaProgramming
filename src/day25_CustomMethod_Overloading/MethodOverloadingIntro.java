...
public class MethodOverloadingIntro {
    ...
    public static void main(String[] args) {
        ...
        double sum2= sumOfNumbers(10.5, 12.4);
       double sumD= sumOfNumbers(22.4, 24.6, 28.5);

       int sum3=  sumOfNumbers(20,40,50);
    ...
    public static double sumOfNumbers(double num1, double num2,double num3, double num4){
        return sumOfNumbers ( num1,  num2,  num3) +num4;//2way- another way to write
        // return num1+ num2+ num3+num4; ==> 1way
    }
